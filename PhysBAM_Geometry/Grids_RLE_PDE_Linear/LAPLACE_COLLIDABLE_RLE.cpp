...
// Function Solve
//#####################################################################
template<class T_GRID> void LAPLACE_COLLIDABLE_RLE<T_GRID>::
...
//#####################################################################
template<class T_GRID> template<class T_FACE> void LAPLACE_COLLIDABLE_RLE<T_GRID>::
Horizontal_Row_Length_Contribution::Apply(const LAPLACE_COLLIDABLE_RLE<T_GRID>& laplace,ARRAY<ARRAY<int> >& row_lengths_array,ARRAY<int>& cell_index_to_matrix_index)
{
...
//#####################################################################
template<class T_GRID> template<class T_FACE> void LAPLACE_COLLIDABLE_RLE<T_GRID>::
Find_Horizontal_Terms::Apply(const LAPLACE_COLLIDABLE_RLE<T_GRID>& laplace,ARRAY<SPARSE_MATRIX_FLAT_NXN<T> >& A_array,ARRAY<VECTOR_ND<T> >& b_array,ARRAY<int>& cell_index_to_matrix_index,
...
//#####################################################################
template<class T_GRID> template<class T_FACE> void LAPLACE_COLLIDABLE_RLE<T_GRID>::
Add_Horizontal_Edges::Apply(const LAPLACE_COLLIDABLE_RLE<T_GRID>& laplace,GRAPH& graph)
{
...
//#####################################################################
template class LAPLACE_COLLIDABLE_RLE<RLE_GRID_2D<float> >;
template class LAPLACE_COLLIDABLE_RLE<RLE_GRID_3D<float> >;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class LAPLACE_COLLIDABLE_RLE<RLE_GRID_2D<double> >;
template class LAPLACE_COLLIDABLE_RLE<RLE_GRID_3D<double> >;
#endif
#endif
