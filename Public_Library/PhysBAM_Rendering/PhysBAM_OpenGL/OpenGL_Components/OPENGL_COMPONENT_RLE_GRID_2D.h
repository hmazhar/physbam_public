...
//#####################################################################
// Class OPENGL_COMPONENT_RLE_GRID_2D
//#####################################################################
#ifndef __OPENGL_COMPONENT_RLE_GRID_2D__
#define __OPENGL_COMPONENT_RLE_GRID_2D__
...
class OPENGL_COMPONENT_RLE_GRID_2D:public OPENGL_COMPONENT
{
public:
    OPENGL_RLE_GRID_2D<T> opengl_grid;
private:
    std::string filename;
    int frame_loaded;
    bool valid;
...
//#####################################################################
    OPENGL_COMPONENT_RLE_GRID_2D(const std::string& filename_input);
