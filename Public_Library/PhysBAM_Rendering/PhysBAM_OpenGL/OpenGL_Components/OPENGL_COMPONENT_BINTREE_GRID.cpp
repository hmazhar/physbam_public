...
//#####################################################################
// OPENGL_COMPONENT_BINTREE_GRID
//#####################################################################
template<class T,class RW> OPENGL_COMPONENT_BINTREE_GRID<T,RW>::
OPENGL_COMPONENT_BINTREE_GRID(const std::string& filename_input):OPENGL_COMPONENT("Bintree Area"),filename(filename_input),frame_loaded(-1),valid(false)
{
...
// Valid_Frame
//#####################################################################
template<class T,class RW> bool OPENGL_COMPONENT_BINTREE_GRID<T,RW>::
...
// Set_Frame
//#####################################################################
template<class T,class RW> void OPENGL_COMPONENT_BINTREE_GRID<T,RW>::
...
// Bounding_Box
//#####################################################################
template<class T,class RW> RANGE<VECTOR<float,3> > OPENGL_COMPONENT_BINTREE_GRID<T,RW>::
Bounding_Box() const
{
...
//#####################################################################
template<class T,class RW> OPENGL_SELECTION* OPENGL_COMPONENT_BINTREE_GRID<T,RW>::
...
Reinitialize()
{
    if((is_animation && frame_loaded!=frame) || (!is_animation && frame_loaded<0)){
        ...
        if(FILE_UTILITIES::File_Exists(filename_string)){
            ...
            opengl_grid.grid.Update_Maximum_Depth();opengl_grid.grid.Set_Maximum_Depth(opengl_grid.grid.maximum_depth);}
        else return;
        frame_loaded=frame;valid=true;}
}
//#####################################################################
template class OPENGL_COMPONENT_BINTREE_GRID<float,float>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class OPENGL_COMPONENT_BINTREE_GRID<double,double>;
#endif
#endif
