...
//#####################################################################
// Class OPENGL_COMPONENT_BINTREE_GRID
//#####################################################################
#if !COMPILE_WITHOUT_DYADIC_SUPPORT || COMPILE_WITH_BINTREE_SUPPORT
#ifndef __OPENGL_COMPONENT_BINTREE_GRID__
#define __OPENGL_COMPONENT_BINTREE_GRID__
...
class OPENGL_COMPONENT_BINTREE_GRID : public OPENGL_COMPONENT
{
public:
    OPENGL_BINTREE_GRID<T>  opengl_grid;
private:
    std::string filename;
    int frame_loaded;
    bool valid;
...
//#####################################################################
    OPENGL_COMPONENT_BINTREE_GRID(const std::string& filename_input);
