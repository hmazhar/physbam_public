...
//#####################################################################
// Class READ_WRITE_RED_TRIANGLE
//#####################################################################
#ifndef COMPILE_WITHOUT_DYADIC_SUPPORT
#ifndef COMPILE_WITHOUT_READ_WRITE_SUPPORT
#ifndef __READ_WRITE_RED_TRIANGLE__
#define __READ_WRITE_RED_TRIANGLE__
...
class Read_Write<RED_TRIANGLE<T>,RW>
{
public:
    static void Read(std::istream& input,RED_TRIANGLE<T>& object)
    ...
    static void Write(std::ostream& output,const RED_TRIANGLE<T>& object)
