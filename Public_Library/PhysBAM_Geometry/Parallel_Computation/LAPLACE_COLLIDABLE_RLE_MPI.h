...
//#####################################################################
// Class LAPLACE_COLLIDABLE_RLE_MPI
//#####################################################################
#ifndef COMPILE_WITHOUT_RLE_SUPPORT
#ifndef __LAPLACE_COLLIDABLE_RLE_MPI__
#define __LAPLACE_COLLIDABLE_RLE_MPI__
...
class LAPLACE_COLLIDABLE_RLE_MPI:public LAPLACE_COLLIDABLE_MPI<T_GRID>
{
public:
    ...
    typedef LAPLACE_COLLIDABLE_MPI<T_GRID> BASE;
    ...
    LAPLACE_COLLIDABLE_RLE_MPI(LAPLACE_COLLIDABLE_RLE<T_GRID>& laplace)
        :LAPLACE_COLLIDABLE_MPI<T_GRID>(laplace)
    {}
