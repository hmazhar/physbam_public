...
//#####################################################################
// Class OPENGL_OCTREE_CELL_SCALAR_FIELD
//##################################################################### 
#ifndef __OPENGL_OCTREE_CELL_SCALAR_FIELD__
#define __OPENGL_OCTREE_CELL_SCALAR_FIELD__
...
class OPENGL_OCTREE_CELL_SCALAR_FIELD:public OPENGL_OBJECT
{
public:
    OCTREE_GRID<T>& grid;
    ARRAY<T2>& value;
    ...
    OPENGL_OCTREE_CELL_SCALAR_FIELD(OCTREE_GRID<T>& grid_input,ARRAY<T2>& value_input,OPENGL_COLOR_MAP<T2>* color_map_input):
